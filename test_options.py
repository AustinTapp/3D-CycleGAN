...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--result", type=str, default='./Data_folder/test/images/result_0.nii',
        ...
        parser.add_argument("--true", type=str, default='./Data_folder/test/labels/0.nii')
