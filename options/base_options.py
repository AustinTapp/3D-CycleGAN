...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--new_resolution', default=(1, 1, 1), help='New resolution (if you want to resample the data again during training') # was 0.45, 0.45, 0.45
        parser.add_argument('--min_pixel', default=0.75, help='Percentage of minimum non-zero pixels in the cropped label')
