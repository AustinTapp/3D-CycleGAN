...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--image", type=str, default='./Data_folder/T1/MRtoCTElastix.nii.gz')
        parser.add_argument("--result", type=str, default='./Data_folder/test/54MRElastix_CT.nii.gz', help='path to the .nii result to save')
