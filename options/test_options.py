...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--image", type=str, default='./Data_folder/holdOut/MR76Bre.nii')
        parser.add_argument("--result", type=str, default='./Data_folder/holdOut/result_0.nii', help='path to the .nii result to save')
